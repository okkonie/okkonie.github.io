...
export default function Hero() {
  return (
    <div className="flex flex-col px-[10vw] pt-[10vh] space-y-8 md:space-y-10">
      ...
      <a 
        href={texts.mailto} 
        className="bg-text/10 w-max py-3 px-4 rounded inline-block text-sm text-text2 hover:text-text hover:bg-text/20 transition-colors duration-150">
        get in touch &rarr;
      </a>
